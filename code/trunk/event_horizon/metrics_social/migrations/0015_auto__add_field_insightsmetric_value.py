...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InsightsMetric.value'
        db.add_column(u'metrics_social_insightsmetric', 'value',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InsightsMetric.value'
        db.delete_column(u'metrics_social_insightsmetric', 'value')
