...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FacebookInsightsReload.reloaded'
        db.delete_column(u'metrics_social_facebookinsightsreload', 'reloaded')


    def backwards(self, orm):
        # Adding field 'FacebookInsightsReload.reloaded'
        db.add_column(u'metrics_social_facebookinsightsreload', 'reloaded',
