...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InsightsMetric.dimension'
        db.add_column(u'metrics_social_insightsmetric', 'dimension',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InsightsMetric.dimension'
        db.delete_column(u'metrics_social_insightsmetric', 'dimension')
    ...
    models = {
        ...
        u'metrics_social.insightsfacebookpagedays28': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'day': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 20, 0, 0)'}),
            'deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'facebook_page': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['social.InsightsFacebookPage']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'page_engaged_users': ('django.db.models.fields.BigIntegerField', [], {'default': '0'}),
