...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'FacebookComment', fields ['facebook_id']
        db.delete_unique(u'metrics_social_facebookcomment', ['facebook_id'])

        # Removing unique constraint on 'FacebookMessage', fields ['facebook_id']
        db.delete_unique(u'metrics_social_facebookmessage', ['facebook_id'])

        # Adding unique constraint on 'FacebookMessage', fields ['facebook_page', 'facebook_id']
        db.create_unique(u'metrics_social_facebookmessage', ['facebook_page_id', 'facebook_id'])

        # Adding unique constraint on 'FacebookComment', fields ['message', 'facebook_id']
        db.create_unique(u'metrics_social_facebookcomment', ['message_id', 'facebook_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'FacebookComment', fields ['message', 'facebook_id']
        db.delete_unique(u'metrics_social_facebookcomment', ['message_id', 'facebook_id'])

        # Removing unique constraint on 'FacebookMessage', fields ['facebook_page', 'facebook_id']
        db.delete_unique(u'metrics_social_facebookmessage', ['facebook_page_id', 'facebook_id'])

        # Adding unique constraint on 'FacebookMessage', fields ['facebook_id']
        db.create_unique(u'metrics_social_facebookmessage', ['facebook_id'])

        # Adding unique constraint on 'FacebookComment', fields ['facebook_id']
        db.create_unique(u'metrics_social_facebookcomment', ['facebook_id'])
    ...
    models = {
        ...
        u'metrics_social.insightsfacebookpagedays28': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'day': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 9, 0, 0)'}),
            'deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'facebook_page': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['social.InsightsFacebookPage']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'page_engaged_users': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
