...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InsightsMetric.title'
        db.add_column(u'metrics_social_insightsmetric', 'title',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'InsightsMetric.description'
        db.add_column(u'metrics_social_insightsmetric', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InsightsMetric.title'
        db.delete_column(u'metrics_social_insightsmetric', 'title')

        # Deleting field 'InsightsMetric.description'
        db.delete_column(u'metrics_social_insightsmetric', 'description')
