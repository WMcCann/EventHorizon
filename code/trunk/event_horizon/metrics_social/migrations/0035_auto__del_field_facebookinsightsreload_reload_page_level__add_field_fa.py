...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FacebookInsightsReload.reload_page_level'
        db.delete_column(u'metrics_social_facebookinsightsreload', 'reload_page_level')

        # Adding field 'FacebookInsightsReload.reload_daily'
        db.add_column(u'metrics_social_facebookinsightsreload', 'reload_daily',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'FacebookInsightsReload.reload_weekly'
        db.add_column(u'metrics_social_facebookinsightsreload', 'reload_weekly',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'FacebookInsightsReload.reload_days_28'
        db.add_column(u'metrics_social_facebookinsightsreload', 'reload_days_28',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'FacebookInsightsReload.reload_dimensions'
        db.add_column(u'metrics_social_facebookinsightsreload', 'reload_dimensions',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'FacebookInsightsReload.reload_page_level'
        db.add_column(u'metrics_social_facebookinsightsreload', 'reload_page_level',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'FacebookInsightsReload.reload_daily'
        db.delete_column(u'metrics_social_facebookinsightsreload', 'reload_daily')

        # Deleting field 'FacebookInsightsReload.reload_weekly'
        db.delete_column(u'metrics_social_facebookinsightsreload', 'reload_weekly')

        # Deleting field 'FacebookInsightsReload.reload_days_28'
        db.delete_column(u'metrics_social_facebookinsightsreload', 'reload_days_28')

        # Deleting field 'FacebookInsightsReload.reload_dimensions'
        db.delete_column(u'metrics_social_facebookinsightsreload', 'reload_dimensions')
    ...
    models = {
        ...
        u'metrics_social.facebookinsightsreload': {
            'Meta': {'ordering': "[u'-created_at']", 'object_name': 'FacebookInsightsReload'},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'facebook_page': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['social.FacebookPage']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'reload_daily': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'reload_days_28': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'reload_dimensions': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'reload_post_level': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'reload_weekly': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'reloaded': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'since': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'until': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'})
        },
