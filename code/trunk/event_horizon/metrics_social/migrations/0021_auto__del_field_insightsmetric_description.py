...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'InsightsMetric.description'
        raise RuntimeError("Cannot reverse this migration. 'InsightsMetric.description' and its values cannot be restored.")
