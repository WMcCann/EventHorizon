...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EvolutionTwitterProfile'
        db.create_table(u'metrics_social_evolutiontwitterprofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('twitter_profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['social.TwitterProfile'])),
            ('followers_count', self.gf('django.db.models.fields.BigIntegerField')(default=0)),
            ('friends_count', self.gf('django.db.models.fields.BigIntegerField')(default=0)),
            ('listed_count', self.gf('django.db.models.fields.BigIntegerField')(default=0)),
            ('favourites_count', self.gf('django.db.models.fields.BigIntegerField')(default=0)),
            ('statuses_count', self.gf('django.db.models.fields.BigIntegerField')(default=0)),
        ...
        db.send_create_signal(u'metrics_social', ['EvolutionTwitterProfile'])


    def backwards(self, orm):
        # Deleting model 'EvolutionTwitterProfile'
        db.delete_table(u'metrics_social_evolutiontwitterprofile')
    ...
    models = {
        ...
        u'metrics_social.twitterfavorite': {
            'Meta': {'ordering': "[u'-created_at']", 'unique_together': "((u'message', u'author_twitter_id'),)", 'object_name': 'TwitterFavorite'},
        ...
        u'metrics_social.twittermessage': {
            ...
            'loaded_favorites': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'loaded_replies': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
