...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InsightsFacebookPost.post_impressions_paid_unique'
        db.alter_column(u'metrics_social_insightsfacebookpost', 'post_impressions_paid_unique', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'InsightsFacebookPost.post_impressions_paid'
        db.alter_column(u'metrics_social_insightsfacebookpost', 'post_impressions_paid', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'InsightsFacebookPost.post_impressions_unique'
        db.alter_column(u'metrics_social_insightsfacebookpost', 'post_impressions_unique', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'InsightsFacebookPost.post_consumptions'
        db.alter_column(u'metrics_social_insightsfacebookpost', 'post_consumptions', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'InsightsFacebookPost.post_stories'
        db.alter_column(u'metrics_social_insightsfacebookpost', 'post_stories', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'InsightsFacebookPost.post_negative_feedback'
        db.alter_column(u'metrics_social_insightsfacebookpost', 'post_negative_feedback', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'InsightsFacebookPost.post_consumptions_unique'
        db.alter_column(u'metrics_social_insightsfacebookpost', 'post_consumptions_unique', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'InsightsFacebookPost.post_negative_feedback_unique'
        db.alter_column(u'metrics_social_insightsfacebookpost', 'post_negative_feedback_unique', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'InsightsFacebookPost.post_engaged_users'
        db.alter_column(u'metrics_social_insightsfacebookpost', 'post_engaged_users', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'InsightsFacebookPost.post_impressions_fan_paid'
        db.alter_column(u'metrics_social_insightsfacebookpost', 'post_impressions_fan_paid', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'InsightsFacebookPost.post_impressions'
        db.alter_column(u'metrics_social_insightsfacebookpost', 'post_impressions', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'InsightsFacebookPost.post_impressions_fan_paid_unique'
        db.alter_column(u'metrics_social_insightsfacebookpost', 'post_impressions_fan_paid_unique', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'InsightsFacebookPost.post_impressions_viral'
        db.alter_column(u'metrics_social_insightsfacebookpost', 'post_impressions_viral', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'InsightsFacebookPost.post_impressions_viral_unique'
        db.alter_column(u'metrics_social_insightsfacebookpost', 'post_impressions_viral_unique', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'InsightsFacebookPost.post_impressions_organic_unique'
        db.alter_column(u'metrics_social_insightsfacebookpost', 'post_impressions_organic_unique', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'InsightsFacebookPost.post_impressions_organic'
        db.alter_column(u'metrics_social_insightsfacebookpost', 'post_impressions_organic', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'InsightsFacebookPost.post_impressions_fan_unique'
        db.alter_column(u'metrics_social_insightsfacebookpost', 'post_impressions_fan_unique', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'InsightsFacebookPost.post_impressions_fan'
        db.alter_column(u'metrics_social_insightsfacebookpost', 'post_impressions_fan', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'InsightsFacebookPost.post_storytellers'
        db.alter_column(u'metrics_social_insightsfacebookpost', 'post_storytellers', self.gf('django.db.models.fields.BigIntegerField')())
        # Adding unique constraint on 'InsightsFacebookPost', fields ['facebook_message', 'facebook_page']
        db.create_unique(u'metrics_social_insightsfacebookpost', ['facebook_message_id', 'facebook_page_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'InsightsFacebookPost', fields ['facebook_message', 'facebook_page']
        db.delete_unique(u'metrics_social_insightsfacebookpost', ['facebook_message_id', 'facebook_page_id'])


        # Changing field 'InsightsFacebookPost.post_impressions_paid_unique'
        db.alter_column(u'metrics_social_insightsfacebookpost', 'post_impressions_paid_unique', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'InsightsFacebookPost.post_impressions_paid'
        db.alter_column(u'metrics_social_insightsfacebookpost', 'post_impressions_paid', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'InsightsFacebookPost.post_impressions_unique'
        db.alter_column(u'metrics_social_insightsfacebookpost', 'post_impressions_unique', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'InsightsFacebookPost.post_consumptions'
        db.alter_column(u'metrics_social_insightsfacebookpost', 'post_consumptions', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'InsightsFacebookPost.post_stories'
        db.alter_column(u'metrics_social_insightsfacebookpost', 'post_stories', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'InsightsFacebookPost.post_negative_feedback'
        db.alter_column(u'metrics_social_insightsfacebookpost', 'post_negative_feedback', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'InsightsFacebookPost.post_consumptions_unique'
        db.alter_column(u'metrics_social_insightsfacebookpost', 'post_consumptions_unique', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'InsightsFacebookPost.post_negative_feedback_unique'
        db.alter_column(u'metrics_social_insightsfacebookpost', 'post_negative_feedback_unique', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'InsightsFacebookPost.post_engaged_users'
        db.alter_column(u'metrics_social_insightsfacebookpost', 'post_engaged_users', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'InsightsFacebookPost.post_impressions_fan_paid'
        db.alter_column(u'metrics_social_insightsfacebookpost', 'post_impressions_fan_paid', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'InsightsFacebookPost.post_impressions'
        db.alter_column(u'metrics_social_insightsfacebookpost', 'post_impressions', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'InsightsFacebookPost.post_impressions_fan_paid_unique'
        db.alter_column(u'metrics_social_insightsfacebookpost', 'post_impressions_fan_paid_unique', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'InsightsFacebookPost.post_impressions_viral'
        db.alter_column(u'metrics_social_insightsfacebookpost', 'post_impressions_viral', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'InsightsFacebookPost.post_impressions_viral_unique'
        db.alter_column(u'metrics_social_insightsfacebookpost', 'post_impressions_viral_unique', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'InsightsFacebookPost.post_impressions_organic_unique'
        db.alter_column(u'metrics_social_insightsfacebookpost', 'post_impressions_organic_unique', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'InsightsFacebookPost.post_impressions_organic'
        db.alter_column(u'metrics_social_insightsfacebookpost', 'post_impressions_organic', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'InsightsFacebookPost.post_impressions_fan_unique'
        db.alter_column(u'metrics_social_insightsfacebookpost', 'post_impressions_fan_unique', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'InsightsFacebookPost.post_impressions_fan'
        db.alter_column(u'metrics_social_insightsfacebookpost', 'post_impressions_fan', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'InsightsFacebookPost.post_storytellers'
        db.alter_column(u'metrics_social_insightsfacebookpost', 'post_storytellers', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'metrics_social.insightsfacebookpagedays28': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'day': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 11, 0, 0)'}),
            'deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'facebook_page': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['social.InsightsFacebookPage']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'page_engaged_users': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
