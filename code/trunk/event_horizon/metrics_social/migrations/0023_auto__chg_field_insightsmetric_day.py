...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InsightsMetric.day'
        db.alter_column(u'metrics_social_insightsmetric', 'day', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'InsightsMetric.day'
        raise RuntimeError("Cannot reverse this migration. 'InsightsMetric.day' and its values cannot be restored.")
