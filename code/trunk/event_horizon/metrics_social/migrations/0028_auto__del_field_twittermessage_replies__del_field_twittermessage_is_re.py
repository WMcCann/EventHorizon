...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TwitterMessage.replies'
        db.delete_column(u'metrics_social_twittermessage', 'replies')

        # Deleting field 'TwitterMessage.is_retweet'
        db.delete_column(u'metrics_social_twittermessage', 'is_retweet')


    def backwards(self, orm):
        # Adding field 'TwitterMessage.replies'
        db.add_column(u'metrics_social_twittermessage', 'replies',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'TwitterMessage.is_retweet'
        db.add_column(u'metrics_social_twittermessage', 'is_retweet',
