...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FacebookInsightsReload'
        db.create_table(u'metrics_social_facebookinsightsreload', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('facebook_page', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['social.FacebookPage'])),
            ('reload_page_level', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('reload_post_level', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('since', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('until', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('reloaded', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ...
        db.send_create_signal(u'metrics_social', ['FacebookInsightsReload'])


    def backwards(self, orm):
        # Deleting model 'FacebookInsightsReload'
        db.delete_table(u'metrics_social_facebookinsightsreload')
    ...
    models = {
        ...
        u'metrics_social.facebookinsightsreload': {
            ...
            'facebook_page': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['social.FacebookPage']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'reload_page_level': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
