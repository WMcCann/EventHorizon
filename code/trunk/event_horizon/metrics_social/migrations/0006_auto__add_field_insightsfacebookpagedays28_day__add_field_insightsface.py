...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InsightsFacebookPageDays28.day'
        db.add_column(u'metrics_social_insightsfacebookpagedays28', 'day',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'InsightsFacebookPageWeekly.day'
        db.add_column(u'metrics_social_insightsfacebookpageweekly', 'day',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InsightsFacebookPageDays28.day'
        db.delete_column(u'metrics_social_insightsfacebookpagedays28', 'day')

        # Deleting field 'InsightsFacebookPageWeekly.day'
        db.delete_column(u'metrics_social_insightsfacebookpageweekly', 'day')
