...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InsightsMetric'
        db.create_table(u'metrics_social_insightsmetric', (
        ...
        db.send_create_signal(u'metrics_social', ['InsightsMetric'])


    def backwards(self, orm):
        # Deleting model 'InsightsMetric'
        db.delete_table(u'metrics_social_insightsmetric')
