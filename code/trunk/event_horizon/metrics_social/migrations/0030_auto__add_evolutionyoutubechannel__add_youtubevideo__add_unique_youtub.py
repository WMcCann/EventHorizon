...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EvolutionYoutubeChannel'
        db.create_table(u'metrics_social_evolutionyoutubechannel', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('youtube_channel', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['social.YoutubeChannel'])),
            ('views_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('videos_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('subscribers_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ...
        db.send_create_signal(u'metrics_social', ['EvolutionYoutubeChannel'])

        # Adding model 'YoutubeVideo'
        db.create_table(u'metrics_social_youtubevideo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('youtube_channel', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['social.YoutubeChannel'])),
            ...
            ('dislikes', self.gf('django.db.models.fields.BigIntegerField')(default=0)),
            ('favorites', self.gf('django.db.models.fields.BigIntegerField')(default=0)),
            ('comments', self.gf('django.db.models.fields.BigIntegerField')(default=0)),
            ('loaded_comments', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, auto_now_add=True, blank=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('deleted', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'metrics_social', ['YoutubeVideo'])

        # Adding unique constraint on 'YoutubeVideo', fields ['youtube_channel', 'youtube_id']
        db.create_unique(u'metrics_social_youtubevideo', ['youtube_channel_id', 'youtube_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'YoutubeVideo', fields ['youtube_channel', 'youtube_id']
        db.delete_unique(u'metrics_social_youtubevideo', ['youtube_channel_id', 'youtube_id'])

        # Deleting model 'EvolutionYoutubeChannel'
        db.delete_table(u'metrics_social_evolutionyoutubechannel')

        # Deleting model 'YoutubeVideo'
        db.delete_table(u'metrics_social_youtubevideo')
