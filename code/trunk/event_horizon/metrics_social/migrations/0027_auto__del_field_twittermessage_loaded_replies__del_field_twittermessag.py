...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TwitterMessage.loaded_replies'
        db.delete_column(u'metrics_social_twittermessage', 'loaded_replies')

        # Deleting field 'TwitterMessage.loaded_favorites'
        db.delete_column(u'metrics_social_twittermessage', 'loaded_favorites')


    def backwards(self, orm):
        # Adding field 'TwitterMessage.loaded_replies'
        db.add_column(u'metrics_social_twittermessage', 'loaded_replies',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TwitterMessage.loaded_favorites'
        db.add_column(u'metrics_social_twittermessage', 'loaded_favorites',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
