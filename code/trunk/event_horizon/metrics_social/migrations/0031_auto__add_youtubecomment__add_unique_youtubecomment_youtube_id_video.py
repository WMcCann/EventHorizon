...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'YoutubeComment'
        db.create_table(u'metrics_social_youtubecomment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('youtube_id', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('video', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['metrics_social.YoutubeVideo'])),
            ('author_youtube_username', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ...
        db.send_create_signal(u'metrics_social', ['YoutubeComment'])

        # Adding unique constraint on 'YoutubeComment', fields ['youtube_id', 'video']
        db.create_unique(u'metrics_social_youtubecomment', ['youtube_id', 'video_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'YoutubeComment', fields ['youtube_id', 'video']
        db.delete_unique(u'metrics_social_youtubecomment', ['youtube_id', 'video_id'])

        # Deleting model 'YoutubeComment'
        db.delete_table(u'metrics_social_youtubecomment')
