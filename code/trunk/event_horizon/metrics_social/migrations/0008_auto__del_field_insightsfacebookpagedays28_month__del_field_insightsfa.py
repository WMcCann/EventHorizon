...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'InsightsFacebookPageDays28.month'
        db.delete_column(u'metrics_social_insightsfacebookpagedays28', 'month')

        # Deleting field 'InsightsFacebookPageDays28.year'
        db.delete_column(u'metrics_social_insightsfacebookpagedays28', 'year')


        # Changing field 'InsightsFacebookPageDays28.day'
        db.alter_column(u'metrics_social_insightsfacebookpagedays28', 'day', self.gf('django.db.models.fields.DateField')())
        # Deleting field 'InsightsFacebookPageWeekly.year'
        db.delete_column(u'metrics_social_insightsfacebookpageweekly', 'year')

        # Deleting field 'InsightsFacebookPageWeekly.week'
        db.delete_column(u'metrics_social_insightsfacebookpageweekly', 'week')


        # Changing field 'InsightsFacebookPageWeekly.day'
        db.alter_column(u'metrics_social_insightsfacebookpageweekly', 'day', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):
        # Adding field 'InsightsFacebookPageDays28.month'
        db.add_column(u'metrics_social_insightsfacebookpagedays28', 'month',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'InsightsFacebookPageDays28.year'
        db.add_column(u'metrics_social_insightsfacebookpagedays28', 'year',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'InsightsFacebookPageDays28.day'
        db.alter_column(u'metrics_social_insightsfacebookpagedays28', 'day', self.gf('django.db.models.fields.DateField')(null=True))
        # Adding field 'InsightsFacebookPageWeekly.year'
        db.add_column(u'metrics_social_insightsfacebookpageweekly', 'year',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'InsightsFacebookPageWeekly.week'
        db.add_column(u'metrics_social_insightsfacebookpageweekly', 'week',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'InsightsFacebookPageWeekly.day'
        db.alter_column(u'metrics_social_insightsfacebookpageweekly', 'day', self.gf('django.db.models.fields.DateField')(null=True))
    ...
    models = {
        ...
        u'metrics_social.insightsfacebookpagedays28': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'day': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 3, 0, 0)'}),
            'deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'facebook_page': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['social.InsightsFacebookPage']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'page_engaged_users': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
