...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'InsightsFacebookPost.day'
        db.delete_column(u'metrics_social_insightsfacebookpost', 'day')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'InsightsFacebookPost.day'
        raise RuntimeError("Cannot reverse this migration. 'InsightsFacebookPost.day' and its values cannot be restored.")
