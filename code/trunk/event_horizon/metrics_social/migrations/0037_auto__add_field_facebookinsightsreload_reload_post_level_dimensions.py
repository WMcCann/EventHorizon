...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FacebookInsightsReload.reload_post_level_dimensions'
        db.add_column(u'metrics_social_facebookinsightsreload', 'reload_post_level_dimensions',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FacebookInsightsReload.reload_post_level_dimensions'
        db.delete_column(u'metrics_social_facebookinsightsreload', 'reload_post_level_dimensions')
    ...
    models = {
        ...
        u'metrics_social.facebookinsightsreload': {
            ...
            'reload_post_level_dimensions': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
