...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EvolutionFacebookPageLike'
        db.create_table(u'metrics_social_evolutionfacebookpagelike', (
        ...
        db.send_create_signal(u'metrics_social', ['EvolutionFacebookPageLike'])


    def backwards(self, orm):
        # Deleting model 'EvolutionFacebookPageLike'
        db.delete_table(u'metrics_social_evolutionfacebookpagelike')
    ...
    models = {
        ...
        u'metrics_social.insightsfacebookpagedays28': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'day': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 6, 0, 0)'}),
            'deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'facebook_page': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['social.InsightsFacebookPage']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'page_engaged_users': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
