...
from metrics_social.models import InsightsMetric, EvolutionFacebookPageLike, FacebookInsightsReload
    ...
    def handle(self, *args, **options):
        ...
        if fbc:
            ...
            if args:
                ...
                ifps = [i for i in FacebookInsightsReload.objects.filter(reload_daily=False, deleted=False)]
