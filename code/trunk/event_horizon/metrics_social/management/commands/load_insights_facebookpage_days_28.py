        ...
        if fbc:
            ...
            if args:
                ifps = [i for i in InsightsFacebookPage.objects.filter(
                                        ...
                                        first_load_days_28=False, 
                                        deleted=False)]
            else:
                ifps = [i for i in InsightsFacebookPage.objects.filter(first_load_days_28=False, deleted=False)]
            ...
            for ifp in ifps:
                ...
                try:
                    since = APIPagination.objects.get(
                        ...
                        path=u'/%s/insights/page_stories/days_28' % ifp.facebook_page.facebook_id,
                        ).offset
