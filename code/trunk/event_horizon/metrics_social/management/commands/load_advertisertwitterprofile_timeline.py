...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if twc:
            ...
            if args:
                atps = AdvertiserTwitterProfile.objects.filter(twitter_id__in=args, first_load=False, deleted=False)
            else:
                atps = AdvertiserTwitterProfile.objects.filter(first_load=False, deleted=False)
