        ...
        if fbc:
            ...
            if args:
                ifps = [i for i in InsightsFacebookPage.objects.filter(
                                        ...
                                        first_load_daily=False, 
                                        deleted=False)]
            else:
                ifps = [i for i in InsightsFacebookPage.objects.filter(first_load_daily=False, deleted=False)]
            ...
            for ifp in ifps:
                ...
                try:
                    since = APIPagination.objects.get(
                        ...
                        path=u'/%s/insights/page_stories/day' % ifp.facebook_page.facebook_id,
                        ).offset
                ...
                while main_loop:
                    ...
                    for metric in metrics:
                        ...
                        if metric == u'page_fans':
                            ...
                            path = u'/%s/insights/%s/day' % (ifp.facebook_page.facebook_id, metric)
