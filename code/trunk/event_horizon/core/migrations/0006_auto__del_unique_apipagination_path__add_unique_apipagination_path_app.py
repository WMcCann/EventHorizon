...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'APIPagination', fields ['path']
        db.delete_unique(u'core_apipagination', ['path'])

        # Adding unique constraint on 'APIPagination', fields ['path', 'app_name', 'model_name']
        db.create_unique(u'core_apipagination', ['path', 'app_name', 'model_name'])


    def backwards(self, orm):
        # Removing unique constraint on 'APIPagination', fields ['path', 'app_name', 'model_name']
        db.delete_unique(u'core_apipagination', ['path', 'app_name', 'model_name'])

        # Adding unique constraint on 'APIPagination', fields ['path']
        db.create_unique(u'core_apipagination', ['path'])
    ...
    models = {
        ...
        u'core.apipagination': {
            'Meta': {'ordering': "[u'model_name']", 'unique_together': "(('app_name', 'model_name', 'path'),)", 'object_name': 'APIPagination'},
            'app_name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
