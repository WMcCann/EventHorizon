...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'APIPagination'
        db.create_table(u'core_apipagination', (
            ...
            ('offset', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ...
        db.send_create_signal(u'core', ['APIPagination'])


    def backwards(self, orm):
        # Deleting model 'APIPagination'
        db.delete_table(u'core_apipagination')
    ...
    models = {
        ...
        u'core.apierror': {
            'Meta': {'ordering': "[u'error']", 'object_name': 'APIError'},
        ...
        u'core.apipagination': {
            'Meta': {'ordering': "[u'model_name']", 'object_name': 'APIPagination'},
            'app_name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'model_name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'offset': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
