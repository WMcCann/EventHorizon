...
INSTALLED_APPS = (
    ...
    'core', # core app
    'metrics_social', # metrics_social app
    'services_social', # services_social app
    'social', # social app
    'dashboard', # dashboard app
    'metrics_media', # metrics_media app
    'services_media', # services_media app
    'media', # media app

    # SYSTEM
    'south', # south to migrate db
)
