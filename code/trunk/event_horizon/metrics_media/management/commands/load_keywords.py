...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        accs = [a for a in AdwordsAccount.objects.filter(first_load_keyword=False, deleted=False)]
        for acc in accs:
            if acc:
                ...
                filename = os.path.join(settings.PROJECT_ROOT_PATH, 'public', 'media', 'adwords', '%s_kw_initial.csv' % acc.client_id)
