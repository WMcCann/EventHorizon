...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AdwordsKeyword.search_exact_match'
        db.alter_column(u'metrics_media_adwordskeyword', 'search_exact_match', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'AdwordsKeyword.avg_position'
        db.alter_column(u'metrics_media_adwordskeyword', 'avg_position', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'AdwordsKeyword.search_impressions_share'
        db.alter_column(u'metrics_media_adwordskeyword', 'search_impressions_share', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'AdwordsKeyword.search_exact_match'
        db.alter_column(u'metrics_media_adwordskeyword', 'search_exact_match', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'AdwordsKeyword.avg_position'
        db.alter_column(u'metrics_media_adwordskeyword', 'avg_position', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'AdwordsKeyword.search_impressions_share'
        db.alter_column(u'metrics_media_adwordskeyword', 'search_impressions_share', self.gf('django.db.models.fields.BigIntegerField')())
