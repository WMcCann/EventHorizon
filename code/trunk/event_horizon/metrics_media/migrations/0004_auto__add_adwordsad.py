...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AdwordsAd'
        db.create_table(u'metrics_media_adwordsad', (
            ...
            ('ad_status', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('ad_id', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('ad', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('description_1', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('description_2', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('display_url', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ...
        db.send_create_signal(u'metrics_media', ['AdwordsAd'])


    def backwards(self, orm):
        # Deleting model 'AdwordsAd'
        db.delete_table(u'metrics_media_adwordsad')
    ...
    models = {
        ...
        u'metrics_media.adwordsad': {
            'Meta': {'ordering': "[u'-created_at']", 'object_name': 'AdwordsAd'},
            'ad': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'ad_id': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'ad_status': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            ...
            'deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'description_1': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'description_2': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'display_url': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'metrics_media.adwordskeyword': {
            ...
            'adgroup_status': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'adwords_account': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['media.AdwordsAccount']"}),
            'avg_position': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            'campaign': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'campaign_id': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'campaign_status': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'clicks': ('django.db.models.fields.BigIntegerField', [], {'default': '0'}),
            ...
            'search_exact_match': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'search_impressions_share': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
