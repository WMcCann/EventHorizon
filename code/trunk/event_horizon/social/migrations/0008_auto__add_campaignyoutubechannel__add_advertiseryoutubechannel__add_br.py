...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CampaignYoutubeChannel'
        db.create_table(u'social_campaignyoutubechannel', (
            (u'youtubechannel_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['social.YoutubeChannel'], unique=True, primary_key=True)),
        ...
        db.send_create_signal(u'social', ['CampaignYoutubeChannel'])

        # Adding model 'AdvertiserYoutubeChannel'
        db.create_table(u'social_advertiseryoutubechannel', (
            (u'youtubechannel_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['social.YoutubeChannel'], unique=True, primary_key=True)),
        ...
        db.send_create_signal(u'social', ['AdvertiserYoutubeChannel'])

        # Adding model 'BrandYoutubeChannel'
        db.create_table(u'social_brandyoutubechannel', (
            (u'youtubechannel_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['social.YoutubeChannel'], unique=True, primary_key=True)),
        ...
        db.send_create_signal(u'social', ['BrandYoutubeChannel'])

        # Adding model 'YoutubeChannel'
        db.create_table(u'social_youtubechannel', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('username', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('youtube_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ...
        db.send_create_signal(u'social', ['YoutubeChannel'])


    def backwards(self, orm):
        # Deleting model 'CampaignYoutubeChannel'
        db.delete_table(u'social_campaignyoutubechannel')

        # Deleting model 'AdvertiserYoutubeChannel'
        db.delete_table(u'social_advertiseryoutubechannel')

        # Deleting model 'BrandYoutubeChannel'
        db.delete_table(u'social_brandyoutubechannel')

        # Deleting model 'YoutubeChannel'
        db.delete_table(u'social_youtubechannel')
