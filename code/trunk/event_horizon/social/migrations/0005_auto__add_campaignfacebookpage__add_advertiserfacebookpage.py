...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CampaignFacebookPage'
        db.create_table(u'social_campaignfacebookpage', (
        ...
        db.send_create_signal(u'social', ['CampaignFacebookPage'])

        # Adding model 'AdvertiserFacebookPage'
        db.create_table(u'social_advertiserfacebookpage', (
            (u'facebookpage_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['social.FacebookPage'], unique=True, primary_key=True)),
        ...
        db.send_create_signal(u'social', ['AdvertiserFacebookPage'])


    def backwards(self, orm):
        # Deleting model 'CampaignFacebookPage'
        db.delete_table(u'social_campaignfacebookpage')

        # Deleting model 'AdvertiserFacebookPage'
        db.delete_table(u'social_advertiserfacebookpage')
