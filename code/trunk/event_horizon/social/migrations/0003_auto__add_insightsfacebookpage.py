...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InsightsFacebookPage'
        db.create_table(u'social_insightsfacebookpage', (
        ...
        db.send_create_signal(u'social', ['InsightsFacebookPage'])


    def backwards(self, orm):
        # Deleting model 'InsightsFacebookPage'
        db.delete_table(u'social_insightsfacebookpage')
