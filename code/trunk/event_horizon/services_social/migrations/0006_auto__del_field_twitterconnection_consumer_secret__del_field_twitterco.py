...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'TwitterConnection.consumer_secret'
        raise RuntimeError("Cannot reverse this migration. 'TwitterConnection.consumer_secret' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'TwitterConnection.consumer_key'
        raise RuntimeError("Cannot reverse this migration. 'TwitterConnection.consumer_key' and its values cannot be restored.")
