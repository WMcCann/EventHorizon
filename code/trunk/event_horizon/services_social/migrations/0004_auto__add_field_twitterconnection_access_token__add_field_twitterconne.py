...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TwitterConnection.access_token'
        db.add_column(u'services_social_twitterconnection', 'access_token',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'TwitterConnection.access_token_secret'
        db.add_column(u'services_social_twitterconnection', 'access_token_secret',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TwitterConnection.access_token'
        db.delete_column(u'services_social_twitterconnection', 'access_token')

        # Deleting field 'TwitterConnection.access_token_secret'
        db.delete_column(u'services_social_twitterconnection', 'access_token_secret')
